package pokercc.android.playrecyclerview.itemdecorator.timeline
...
import pokercc.android.ui.recyclerview.databinding.RecyTimeLineFragmentBinding

internal class TimeLineFragment : Fragment() {
    val data = listOf(
        Item("开发首款产品", "伟大若有初衷，都出自渺小的理由十余人团队，同一个方向由工具开始，从经期出发只想让女生的世界变得不一样"),
        Item(
            "美柚App正式上线",
            "初始化的进程很卡，起跑需要加速度（118°E，24°N）Xiamen，30天封闭式打磨美柚1.0版iOS、Android双平台发布梦想在不断迭代中萌芽，愈发明亮"
        ),
    ...
    private lateinit var viewBinding: RecyTimeLineFragmentBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = RecyTimeLineFragmentBinding.inflate(inflater, container, false)
        return viewBinding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewBinding.recyclerView.adapter = TimeAdapter(data)
        ...
        viewBinding.button.setOnClickListener {
            onChangeTimeLineClick(it)
        }
    }

    private fun onChangeTimeLineClick(view: View) {
        val headerDrawable = resources.getDrawable(R.drawable.header).mutate() as GradientDrawable
        headerDrawable.setSize(22, 22)
                    ...
                    2 -> {
                        ...
                        viewBinding.recyclerView.addItemDecoration(
                            ThroughTimeLineDecorator(
                                ...
                                val marginTop =
                                    childLocation[1] - parentLocation[1] + tvTitle.height / 2
                                marginTop
                            }
                        )
                    }
...
class TimeAdapter(private val items: List<Item>) : Adapter<ItemViewHolder>() {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ItemViewHolder {
        return ItemViewHolder(
            LayoutInflater.from(p0.context).inflate(R.layout.recy_time_line_item, p0, false)
        )
    }
